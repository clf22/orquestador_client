...
export class FormComponent {
  ...
  async onSubmit() {
    ...
    try {
      console.log('Sale>>>>',this.myForm.value);
      if(await this.submitFn({form: this.myForm.value})) this.toast.success(`${this.name?.toUpperCase()} creado correctamente`, 'Exito!')
    } catch (error:any) {
      console.error(error);
